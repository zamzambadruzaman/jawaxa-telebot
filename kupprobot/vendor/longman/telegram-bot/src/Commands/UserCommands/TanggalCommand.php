 ...
 * User "/date" command
 */
class TanggalCommand extends UserCommand
{
    /**#@+
     * {@inheritdoc}
     */
    ...
    private function getFormattedDate($location)
    {
        ...
        return 'Waktu setempat untuk ' . $timezone_id . ' adalah : ' . $date_utc->format($this->date_format);
    }
    ...
    public function execute()
    {
        ...
        if (empty($text)) {
            $text = 'Silahkan sebutkan lokasi : /tanggal kota';
        } else {
