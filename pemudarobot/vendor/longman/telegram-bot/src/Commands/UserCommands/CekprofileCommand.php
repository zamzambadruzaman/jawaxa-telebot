 ...
 * User "/whoami" command
 */
class CekprofileCommand extends UserCommand
{
    /**#@+
     * {@inheritdoc}
     */
    protected $name = 'cekprofile';
    protected $description = 'Memperlihatkan ID anda, nama dan username';
    protected $usage = '/cekprofile';
    ...
    public function execute()
    {
        ...
        $caption = 'ID Anda: ' . $user_id . "\n";
        $caption .= 'Nama: ' . $message->getFrom()->getFirstName()
